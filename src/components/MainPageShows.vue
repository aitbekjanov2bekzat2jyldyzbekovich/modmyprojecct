<template>
    <section>
        <div class="shpwsConteiner">
            ...
            <div class="contShows">
                <div class="cards" v-for=" item, index in this.fcontentStore.shows">
                    <div class="imgShows">
                    ...
                    <div class="cardsName">
                        ...
                        <div @click="this.favStore.addFavorite(item.image, item.id, item.name) "
                        @dblclick="this.favStore.Delatefav(item.id)">
                            <Like />
                        </div>
...
export default {
    computed: {
        ...mapStores(useFcontentStore, useFavStore)
    },
